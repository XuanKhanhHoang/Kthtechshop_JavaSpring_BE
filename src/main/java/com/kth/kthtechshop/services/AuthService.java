...
public class AuthService {
    ...
    public LoginResponseDTO loginByFacebook(String email, String facebookId) {
        ...
        return new LoginResponseDTO(jwtUtil.generateToken(user.getId(), user.getRoles()), new UserGeneralDetailsDTO(user.getId(), user.getFirstName(), user.getAvatar(), user.getRoles()));
    }
}
